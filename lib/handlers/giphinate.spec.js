...
describe('giphinate handler', () => {
  ...
  it('calls giphy repository to find by query text with queryText request parameter', () => {
    ...
    giphyRepositoryStub.findByQueryText.returns(Promise.resolve())
  ...
  it('responds successfully with url when giphy repository url search has succeeded', (done) => {
    ...
    giphyRepositoryStub.findByQueryText.returns(Promise.resolve(foundUrl))
  ...
  describe('when giphy repository search fails', () => {
    ...
    it('responds with not found error and 404 status code when giphy service search has failed', (done) => {
      ...
      getUrlByQueryTextStub.returns(Promise.reject('Error'))
