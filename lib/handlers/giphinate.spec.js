...
describe('giphinate handler', () => {
  ...
  describe('when giphy repository search fails', () => {
    ...
    it('responds with Not Found Error (404) status when giphy service has not found giphy url', (done) => {
    ...
    it('responds with Internal Server Error (500) status when giphy service search has failed', (done) => {
